...
#
#    Last updated to give ringed seal haul-out predictions based on Markus et al. melt covariate
#    Paul Conn, 8 Feb 2021
#
#######
...
save(Data_chess_us,file="CHESS_us_data_TMB_Feb2021.RData")
